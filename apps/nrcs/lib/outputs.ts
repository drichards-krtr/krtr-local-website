...
export type WebOutput = { id: string; revision: number; status: string; copy_version_id: string | null; slug: string | null; hero_asset_id: string | null; video_asset_id?: string | null; tease?: string | null; seo_title: string | null; seo_description: string | null; scheduled_at: string | null; published_at: string | null };
