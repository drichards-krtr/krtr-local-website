...
export default async function MigrationsPage() {
  ...
  return <MigrationConsole owners={owners.data || []} terms={terms.data || []} districts={(districts.data || []).map(district => ({ key: district.district_key, name: district.display_name + (district.enabled ? "" : " (Disabled)") }))} defaultDistrict={context.activeDistrict?.district_key || ""} />;
}
